...
description: 'Design and audit lead generation systems using Alex Hormozi''s Core Four, Lead Magnets, More-Better-New scaling, and the four Lead Getters. Use when the user mentions "Core Four", "lead magnet", "warm outreach", "cold outreach", "Hook Retain Reward", "More Better New", "Open To Goal", "Rule of 100", "Seven Levels of Advertisers", "engaged leads", "client financed acquisition", "Hormozi", or "$100M Leads". Also trigger when the user says "I need more leads", "ads aren''t working", "no one is signing up", "my pipeline is empty", "how do I get my first 100 customers", or wants a referral program, affiliate program, cold email sequence, ad creative, content plan, lead magnet, or one-page advertising plan.'
license: MIT
metadata:
